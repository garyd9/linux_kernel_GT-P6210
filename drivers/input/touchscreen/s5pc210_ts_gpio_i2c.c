...
#elif CONFIG_I2C_CHANNEL_5
#define	GPIO_I2C_SDA_CON_PORT (*(unsigned long *)GPB1CON)
#define	GPIO_I2C_SDA_DAT_PORT (*(unsigned long *)GPB1DAT)
#define	GPIO_SDA_PIN 6

#define	GPIO_I2C_CLK_CON_PORT (*(unsigned long *)GPB1CON)
#define	GPIO_I2C_CLK_DAT_PORT (*(unsigned long *)GPB1DAT)
